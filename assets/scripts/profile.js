import { fetchData } from "./MyFetcher.js";
import { displayBasicUserData, displayData } from "./affiche.js";
import { shuffleArray } from "./scripts.js";
  ...
  try {
    ...
    const topTenProjects = transaction
      ...
      projects.forEach(project => {
          ...
          const projectName = project.path.split('/').pop(); // Extract the last part of the path
    ...
    for (let i = 0; i < shuffledTopTenProjects.length; i++) {
      ...
      bar.setAttribute("fill", "#3b5998");

      // Add interactivity
      bar.addEventListener("mouseover", () => {
        bar.setAttribute("fill", "lightgray");
        ...
        textBelow.setAttribute("fill", "#3b5998");
        ...
        textAbove.setAttribute("fill", "#3b5998");
    ...
    pathAuditDone.setAttribute("fill", "#3b5998");
    ...
    pathAuditReceived.setAttribute("fill", "lightgray");
    pathAuditReceived.setAttribute(
      "transform",
      "rotate(-90 " + center.x + " " + center.y + ")"
    );
